...
4.Build
Step1: run cmd: cd android
Step2: run cmd:  ./gradlew assembleRelease
5.APK đã tạo có thể được tìm thấy trong android/app/build/outputs/apk/app-release.apk và sẵn sàng sử dụng.
```