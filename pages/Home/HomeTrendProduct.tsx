...
const HomeTrendProduct: React.FunctionComponent<Props> = ({goToDetails, item = {}}: Props) => {
  const theme: AppTheme = useTheme();

  return (
    <TouchableOpacity key={item['id']} style={[style.newItemBox]} onPress={goToDetails}>
      <Image style={[style.newItem]} source={{uri: item['thumbnail']}} />
      <View>
...
export default HomeTrendProduct;
